...
The update file is just a bash script to help me do the basic git functions
of add, commit and push without having to do it repeatedly.

## Description :house:

AirBnB is a complete web application, integrating database storage, 
a back-end API, and front-end using cmd console.
